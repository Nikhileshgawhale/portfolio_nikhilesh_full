          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg text-white font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all"
              >
                Send Message
              </motion.button>
            </form>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-300">
                    <span className="text-blue-400">Location:</span> San Francisco, CA
                  </p>
                </div>
              </div>
            </div>
