...
const projects = [
  {
    ...
    description: "Developed a real-time image recognition system using deep learning and computer vision techniques. Implemented transfer learning with ResNet50 and achieved 95% accuracy on custom datasets.",
  ...
  },
  {
    ...
    description: "Built an end-to-end NLP pipeline for text classification and sentiment analysis. Implemented BERT-based models and achieved state-of-the-art results on multiple benchmark datasets.",
    technologies: ["Python", "PyTorch", "Hugging Face", "AWS"],
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    link: "#",
  },
  {
    title: "Autonomous Vehicle Simulation",
    description: "Created a simulation environment for testing autonomous vehicle algorithms. Implemented reinforcement learning for path planning and obstacle avoidance.",
    technologies: ["C++", "ROS", "Gazebo", "TensorFlow"],
